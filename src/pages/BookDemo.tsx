    ...
    <div className="min-h-screen bg-luxury-black flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-lg font-bold text-white font-display">Book a Live Demo</h1>
          <p className="text-[10px] text-gray-500 mt-1">30-minute walkthrough of the LeadLuxe AI platform</p>
        </div>
        ...
        {step === 0 ? (
          <div className="space-y-4">
            ...
            <button onClick={() => setStep(1)} disabled={!form.name || !form.email}
              ...
              <ArrowRight className="w-4 h-4" /> Select Time
            </button>
          </div>
        ) : (
          <div className="space-y-4">
