// ============================================================
// LeadLuxe AI — India Opportunity Report (/reports/india-opportunity)
...
export function IndiaOpportunityReport() {
  ...
  const handleCapture = (e: React.FormEvent) => {
    e.preventDefault();
    if (!email) return;
    const downloads = JSON.parse(localStorage.getItem('leadluxe-report-downloads') || '[]');
    downloads.unshift({ email, name, company, report: 'india-opportunity', timestamp: new Date().toISOString() });
    localStorage.setItem('leadluxe-report-downloads', JSON.stringify(downloads));
    setSubmitted(true);
  ...
  return (
    <>
      <SEOHelmet
        ...
        url="https://leadluxe-ai.vercel.app/reports/india-opportunity"
        canonical="https://leadluxe-ai.vercel.app/reports/india-opportunity"
      />
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-lg bg-white/[0.02] border border-white/[0.06]">
                  ...
                  <p className="text-[8px] text-gray-700 text-center mt-1">
                    Generated by LeadLuxe AI — All conclusions are based on cited sources and verification status.
                  </p>
                </div>
              </div>
            </div>
