...
export function generateInvestmentReport(
  ...
  return {
    ...
    disclaimer: 'This report is generated by TerraNexus AI for informational purposes only. It does not constitute financial advice, investment recommendation, or solicitation. All investment decisions should be made after consulting with qualified professionals. TerraNexus earns commission only when a deal closes — we are aligned with your success.',
  };
}
...
<body>
  ...
  <div class="report">
    ...
    <div class="disclaimer">
      ...
      <p style="margin-top: 8px;">TerraNexus AI · ${report.generatedAt}</p>
    </div>
  </div>
</body>
</html>`;
