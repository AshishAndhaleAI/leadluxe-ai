...
//   1. window.__TERRANEXUS_PROXY_URL
...
try {
  ...
  autonomousIntelligence.runCycle().then(() => {
    console.log('[TerraNexusAI] Initial intelligence cycle complete');
  }).catch(() => {
    // Silently handle — app should work without AI backend
  });
} catch (e) {
  console.warn('[TerraNexusAI] Intelligence initialization deferred:', e);
}
